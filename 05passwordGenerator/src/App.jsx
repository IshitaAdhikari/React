...
//use effect: runs the function inside it whenever the page
//renders first-time or dependencies are changed
//use ref: used to give reference of selected components in 
//our page so that functions can be performed on referenced values
...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    ...
    for (let i = 1; i <= length; i++) {
      ...
      pass += str.charAt(char)     //if we only write = here than it will generate only one word
    }
